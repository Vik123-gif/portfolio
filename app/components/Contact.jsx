...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      id="contact"
      className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-center bg-[length:90%_auto] dark:bg-none'
    >
      <motion.h4
      ...
      >
        ...
        <motion.textarea
          ...
          required
          className="w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb- dark:bg-darkHover/30 dark:border-white/90"
          name="message"
        ></motion.textarea>
        <motion.button
